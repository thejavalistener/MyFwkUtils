...
/** VOLAAAARRR CUANDO ESTE 100% PASADO */
public class MyReflectionExMyClass
{
	...
	{
		String setterName = MyReflection.method.getSetterName(f);
	...
	{
		String getterName = MyReflection.method.getGetterName(f);
