...
{
	/** Instancia dinámicamente la clase $classname por su nombre */
	...
	/** Instancia dinámicamente a $class por su constructor nulo */
	...
	/** Retorna la clase que wrappea al tipo primitivo $primitiveClass. Por ejemplo:
	 * getWrapperFor(Integet.TYPE) retorna: Integet.class 
	 */
	public static Class<?> getWrapperFor(Class<?> primitiveClass)
	{
		return getWrapperFor(primitiveClass.getName());
	}
	
	/** Ejemplo: getWrapperFor("int") retorna: Integer.class */
	public static Class<?> getWrapperFor(String primitiveTypename)
	{
		switch( primitiveTypename )
		{
			...
			case "void":
				return Void.class;
			default:
				throw new IllegalArgumentException(primitiveTypename+" no es un tipo primitivo válido.");
		}		
	}
	
	/** Dada la clase wrapper retorna su tipo primitivo */
	public static Class<?> getPrimitiveFor(Class<?> wrapperClass)
	{
		switch( wrapperClass.getName() )
		{
			...
			case "java.lang.Void":
				return Void.TYPE;
			default:
				throw new IllegalArgumentException(wrapperClass+" no es un wrapper válido.");
		}		
	}
	
    /** retorna true si clazz representa a alguno de los tipos primitivos, 
     *  sus wrappers, Date,Time o Timestamp*/
