...
public class MyComboBoxBKP<T> implements MyComponent
{
	...
	public MyComboBoxBKP()
	{
		this(null,null,true);
	}

	public MyComboBoxBKP(ItemListener itemListener)
	{
		this(itemListener,true);
	}
	public MyComboBoxBKP(ItemListener itemListener,boolean listenerWorking)
	{
		this(null,itemListener,listenerWorking);
	}
		
	public MyComboBoxBKP(Function<T,String> tToString)
	{
		this(tToString,null,true);
	}

	public MyComboBoxBKP(Function<T,String> tToString,ItemListener itemListener,boolean listenerWorking)
	{
